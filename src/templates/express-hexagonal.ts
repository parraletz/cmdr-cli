...
export async function generateExpressHexagonalProject(
  projectName: string,
  options: {
    git?: boolean
    repository?: string
  ...
  try {
    ...
    readmeContent = readmeContent.replace(
      /git clone https:\/\/github\.com\/parraletz\/express-hexagonal-boilerplate\.git/,
    ...
    if (shouldInitializeGit) {
      ...
      await projectGit.commit('Initial commit from express-hexagonal-boilerplate')
    }
  } catch (error) {
